...
public class TestEmployee {
    ...
    @Features("REST Services Testing")
    @Test(dependsOnMethods="testGetNumberOfEmployees", groups = {"demo"})
    ...
    @Features("REST Services Testing")
    @Test(dependsOnMethods="testCreateEmployee", groups = {"demo"})
    ...
    @Features("REST Services Testing")
    @Test(dependsOnMethods="testEmployeeDetails", groups = {"demo"})
