...
public class TestManageDepartments_Original  extends TestEnvironment {
	...
	// Add a new dept
	TestReporter.logStep("Add a new department");
    ...
    */
	...
	TestReporter.logStep("Delete new department");
	// Delete the new dept
	...
	TestReporter.logStep("Verify new department is deleted and sub-department is moved up a domain");
	// Verify the dept is displayed on the dept results table
